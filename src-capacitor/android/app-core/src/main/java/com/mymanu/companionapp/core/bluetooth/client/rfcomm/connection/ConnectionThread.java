...
package com.mymanu.companionapp.core.bluetooth.client.rfcomm.connection;
...
public class ConnectionThread extends Thread {
    ...
    private static final boolean LOG_METHODS = DEBUG.Bluetooth.Rfcomm.CONNECTION_THREAD;
