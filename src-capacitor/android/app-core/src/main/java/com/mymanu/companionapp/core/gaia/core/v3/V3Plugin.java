...
package com.mymanu.companionapp.core.gaia.core.v3;
...
import com.mymanu.companionapp.core.gaia.core.v3.packets.V3PacketType;
 ...
 * {@link V3PacketType#RESPONSE}. This is the expected response
...
public abstract class V3Plugin extends Plugin {
     ...
     * <p>{@link V3PacketType#COMMAND} packets are unexpected
     ...
     * {@link V3PacketType#NOTIFICATION} that matches the vendor
    ...
    /**
     * <p>This is called when the plugin receives a V3 packet of type
     * {@link V3PacketType#RESPONSE} that matches the vendor and
    ...
    /**
     * <p>This is called when the plugin receives a V3 packet of type
     * {@link V3PacketType#ERROR} that matches the vendor and the
