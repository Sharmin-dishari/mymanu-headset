...
import com.mymanu.companionapp.core.gaia.qtil.data.gestures.GestureFactory;
import com.mymanu.companionapp.core.gaia.qtil.data.gestures.GetGestureConfigurationParameters;
import com.mymanu.companionapp.core.gaia.qtil.data.gestures.GetGestureConfigurationResponse;
...
import com.mymanu.companionapp.core.gaia.qtil.data.gestures.TouchpadConfigurationType;
...
public class V3GestureConfigurationPlugin extends V3QTILPlugin implements GestureConfigurationPlugin {
    ...
    public V3GestureConfigurationPlugin(@NonNull GaiaSender sender) {
        this(sender, GaiaClientService.getPublicationManager());
    }
        ...
        switch (info) {
            case SET_GESTURE_CONFIGURATION:
                if (value instanceof SetGestureConfiguration) {
                    ...
                    List<byte[]> payloads = setter.getPayloads(getMaxPayloadSize(SizeInfo.OPTIMUM_RX_PAYLOAD));
    ...
    private void onConfigurationChanged(byte[] data) {
        ...
        int value = BytesUtils.getUINT8(data, GESTURE_OFFSET);
        int id = BytesUtils.getValueFromBits(value, GESTURE_BIT_OFFSET, GESTURE_BIT_LENGTH);
    ...
    private void onGetNumberOfTouchpads(byte[] data) {
        ...
        int NUMBER_OFFSET = 0;
        int value = BytesUtils.getUINT8(data, NUMBER_OFFSET);
