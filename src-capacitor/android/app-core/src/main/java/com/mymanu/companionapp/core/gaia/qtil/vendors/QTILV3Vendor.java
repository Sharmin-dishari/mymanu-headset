...
import com.mymanu.companionapp.core.gaia.core.v3.V3Vendor;
import com.mymanu.companionapp.core.gaia.core.v3.packets.V3Packet;
import com.mymanu.companionapp.core.gaia.qtil.data.Feature;
...
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.FeaturesFetcher;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.FeaturesFetcherListener;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3ANCPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3AudioCurationPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3BasicPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3BatteryPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3DebugPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3EarbudFitPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3EarbudPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3GestureConfigurationPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3HandsetServicePlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3MusicProcessingPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3QTILPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3QTILPluginError;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3StatisticsPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3UpgradePlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3VoiceProcessingPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3VoiceUIPlugin;
import com.mymanu.companionapp.core.gaia.qtil.plugins.v3.V3XpanPlugin;
import com.mymanu.companionapp.core.logs.DownloadLogsHelper;
...
public class QTILV3Vendor extends V3Vendor implements QTILVendor {
    ...
    private V3QTILPlugin buildPlugin(Feature feature) {
        ...
        switch (qtilFeature) {
            ...
            case XPAN:
                return new V3XpanPlugin(getSender());
            default:
                return null;
        }
    }
        ...
        basicPlugin.registerNotification(plugin.getQTILFeature(),
                                         new PluginStarter(() -> {
                                             if (plugin.getQTILFeature() == QTILFeature.UPGRADE) {
                                                 ...
                                                 GaiaClientService.getTaskManager().schedule(((V3UpgradePlugin) plugin)::onPlugged, 1000);
                                             }
