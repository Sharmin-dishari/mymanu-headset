...
import com.mymanu.companionapp.ui.discovery.viewdata.ItemViewData
import com.mymanu.companionapp.ui.discovery.viewdata.TitleViewData
...
class DiscoveryViewModel @Inject constructor(
    ...
    private fun getQuantityString(resourceId: Int, count: Int): String {
        return getApplication<Applicat>().resources.getQuantityString(resourceId, count)
    }

    private fun getString(resourceId: Int): String {
        return getApplication<Applicat>().getString(resourceId)
    }
