 ...
 * ************************************************************************************************
 */
package com.mymanu.companionapp.ui.information

import android.app.Application
import androidx.collection.ArrayMap
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.Observer
import com.mymanu.companionapp.Applicat
...
import com.mymanu.companionapp.repository.deviceinfo.DeviceInformation
...
class InformationViewModel @Inject constructor(
    ...
    private fun fetchData() {
        val context = getApplication<Applicat>()
    ...
    private fun updateFeaturesInformation(supportedFeatures: ArrayMap<QTILFeature, Int>?) {
        ...
        val description = getApplication<Applicat>().getString(descriptionId)
    ...
    private fun updateConnectedDevice(resource: Resource<Device, BluetoothStatus>?) {
        ...
        // build data object
        val name = device?.name ?: getApplication<Applicat>().getString(R.string.unknown_device)
        val address =
            device?.bluetoothAddress ?: getApplication<Applicat>().getString(R.string.unknown_bluetooth_address)
    ...
    private fun fetchBatteryLevels(supported: Set<Battery>?) {
        ...
        val context = getApplication<Applicat>().applicationContext
    ...
    private fun formatBatteryLevel(battery: Battery, level: Int): String {
        ...
        return getApplication<Applicat>().applicationContext
    ...
    private fun getString(resourceId: Int): String {
        return getApplication<Applicat>().applicationContext.getString(resourceId)
    }
