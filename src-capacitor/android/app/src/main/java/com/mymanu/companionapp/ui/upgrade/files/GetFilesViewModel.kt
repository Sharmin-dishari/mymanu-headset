...
import com.mymanu.companionapp.repository.deviceinfo.InfoUtils
import com.mymanu.companionapp.repository.service.Result
import com.mymanu.companionapp.repository.service.ServiceError
...
import com.mymanu.companionapp.repository.service.getfiles.GetFilesError
...
class GetFilesViewModel @Inject constructor(
    ...
    private fun getErrorMessage(error: ServiceError): String {
        return when (error) {
            ...
            is ServiceError.ResponseError.EmptyResponse -> getApplication<Applicat>().getString(
    ...
    private fun getString(resourceId: Int): String {
        val application = getApplication<Applicat>()
